...
{
//----------------------------------------------------------------------------------------------------------------------
	class CSocketUDPManagerMenu final : public CPPFoundation::Foundation::CConsoleMenu, private CPPFoundation::Foundation::ISocketUDPManagerCallback
	{
//----------------------------------------------------------------------------------------------------------------------
		private:
		...
		private:
			...
			void MenuItemRegisterEvent(const CPPFoundation::Foundation::CConsoleMenuItemCommandParams& CommandParams);
			void MenuItemUnregisterEvent(const CPPFoundation::Foundation::CConsoleMenuItemCommandParams& CommandParams);
		...
		public:
			CSocketUDPManagerMenu(CPPFoundation::Foundation::CConsoleLogWriter& LogWriter);
			virtual ~CSocketUDPManagerMenu(void) override;
//----------------------------------------------------------------------------------------------------------------------
	};
//----------------------------------------------------------------------------------------------------------------------
}
