//----------------------------------------------------------------------------------------------------------------------
#include "CTestStateMachineException4.h"
...
//----------------------------------------------------------------------------------------------------------------------
	bool CTestStateMachineException4::InternalExecuteStateMachine(CCSPStateInput StateInput)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException4::InternalTerminateStateMachine(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	CTimeout CTestStateMachineException4::InternalGetStateMachineTimeout(CSteadyClock::Milliseconds TimeInMS) const
	{
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException4::StateMachineStartedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException4::StateMachineFinishedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException4::StateMachineExpiredEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException4::StateMachineStateChangedEvent(const CState&, const CString&)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	bool CTestStateMachineException4::StateMachineStateOutputFiringEvent(CCSPStateOutput StateOutput)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException4::ChildStateMachineAddedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException4::ChildStateMachineFinishedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetInternalGetStateMachineStartState1(void) const noexcept
	{
		return(MInternalGetStateMachineStartState1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetInternalGetStateMachineStartState2(void) const noexcept
	{
		return(MInternalGetStateMachineStartState2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetInternalExecuteStateMachine1(void) const noexcept
	{
		return(MInternalExecuteStateMachine1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetInternalExecuteStateMachine2(void) const noexcept
	{
		return(MInternalExecuteStateMachine2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineExecuteStateMachineStateInput1Event1(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput1Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineExecuteStateMachineStateInput1Event2(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput1Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineExecuteStateMachineStateInput2Event1(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput2Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineExecuteStateMachineStateInput2Event2(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput2Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineExecuteStateMachineStateInput3Event1(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput3Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineExecuteStateMachineStateInput3Event2(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput3Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineExecuteStateMachineStateInput4Event1(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput4Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineExecuteStateMachineStateInput4Event2(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput4Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetInternalTerminateStateMachine1(void) const noexcept
	{
		return(MInternalTerminateStateMachine1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetInternalTerminateStateMachine2(void) const noexcept
	{
		return(MInternalTerminateStateMachine2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetInternalGetStateMachineTimeout1(void) const noexcept
	{
		return(MInternalGetStateMachineTimeout1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetInternalGetStateMachineTimeout2(void) const noexcept
	{
		return(MInternalGetStateMachineTimeout2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStartedEvent1(void) const noexcept
	{
		return(MStateMachineStartedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStartedEvent2(void) const noexcept
	{
		return(MStateMachineStartedEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineFinishedEvent1(void) const noexcept
	{
		return(MStateMachineFinishedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineFinishedEvent2(void) const noexcept
	{
		return(MStateMachineFinishedEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineExpiredEvent1(void) const noexcept
	{
		return(MStateMachineExpiredEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineExpiredEvent2(void) const noexcept
	{
		return(MStateMachineExpiredEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStateChangedEvent1(void) const noexcept
	{
		return(MStateMachineStateChangedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStateChangedEvent2(void) const noexcept
	{
		return(MStateMachineStateChangedEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStateOutputFiringEvent1(void) const noexcept
	{
		return(MStateMachineStateOutputFiringEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStateOutputFiringEvent2(void) const noexcept
	{
		return(MStateMachineStateOutputFiringEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStateOutputFiredStateOutput1Event1(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput1Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStateOutputFiredStateOutput1Event2(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput1Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStateOutputFiredStateOutput2Event1(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput2Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStateOutputFiredStateOutput2Event2(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput2Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStateOutputFiredStateOutput3Event1(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput3Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStateOutputFiredStateOutput3Event2(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput3Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStateOutputFiredStateOutput4Event1(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput4Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetStateMachineStateOutputFiredStateOutput4Event2(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput4Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetChildStateMachineAddedEvent1(void) const noexcept
	{
		return(MChildStateMachineAddedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetChildStateMachineAddedEvent2(void) const noexcept
	{
		return(MChildStateMachineAddedEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetChildStateMachineFinishedEvent1(void) const noexcept
	{
		return(MChildStateMachineFinishedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException4::GetChildStateMachineFinishedEvent2(void) const noexcept
	{
