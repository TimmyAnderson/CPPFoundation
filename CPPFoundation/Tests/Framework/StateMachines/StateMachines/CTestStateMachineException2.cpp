//----------------------------------------------------------------------------------------------------------------------
#include "CTestStateMachineException2.h"
...
//----------------------------------------------------------------------------------------------------------------------
	bool CTestStateMachineException2::InternalExecuteStateMachine(CCSPStateInput StateInput)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException2::InternalTerminateStateMachine(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	CTimeout CTestStateMachineException2::InternalGetStateMachineTimeout(CSteadyClock::Milliseconds TimeInMS) const
	{
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException2::StateMachineStartedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException2::StateMachineFinishedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException2::StateMachineExpiredEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException2::StateMachineStateChangedEvent(const CState&, const CString&)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	bool CTestStateMachineException2::StateMachineStateOutputFiringEvent(CCSPStateOutput StateOutput)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException2::ChildStateMachineAddedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException2::ChildStateMachineFinishedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetInternalGetStateMachineStartState1(void) const noexcept
	{
		return(MInternalGetStateMachineStartState1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetInternalGetStateMachineStartState2(void) const noexcept
	{
		return(MInternalGetStateMachineStartState2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetInternalExecuteStateMachine1(void) const noexcept
	{
		return(MInternalExecuteStateMachine1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetInternalExecuteStateMachine2(void) const noexcept
	{
		return(MInternalExecuteStateMachine2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineExecuteStateMachineStateInput1Event1(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput1Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineExecuteStateMachineStateInput1Event2(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput1Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineExecuteStateMachineStateInput2Event1(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput2Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineExecuteStateMachineStateInput2Event2(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput2Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineExecuteStateMachineStateInput3Event1(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput3Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineExecuteStateMachineStateInput3Event2(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput3Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineExecuteStateMachineStateInput4Event1(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput4Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineExecuteStateMachineStateInput4Event2(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput4Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetInternalTerminateStateMachine1(void) const noexcept
	{
		return(MInternalTerminateStateMachine1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetInternalTerminateStateMachine2(void) const noexcept
	{
		return(MInternalTerminateStateMachine2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetInternalGetStateMachineTimeout1(void) const noexcept
	{
		return(MInternalGetStateMachineTimeout1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetInternalGetStateMachineTimeout2(void) const noexcept
	{
		return(MInternalGetStateMachineTimeout2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStartedEvent1(void) const noexcept
	{
		return(MStateMachineStartedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStartedEvent2(void) const noexcept
	{
		return(MStateMachineStartedEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineFinishedEvent1(void) const noexcept
	{
		return(MStateMachineFinishedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineFinishedEvent2(void) const noexcept
	{
		return(MStateMachineFinishedEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineExpiredEvent1(void) const noexcept
	{
		return(MStateMachineExpiredEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineExpiredEvent2(void) const noexcept
	{
		return(MStateMachineExpiredEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStateChangedEvent1(void) const noexcept
	{
		return(MStateMachineStateChangedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStateChangedEvent2(void) const noexcept
	{
		return(MStateMachineStateChangedEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStateOutputFiringEvent1(void) const noexcept
	{
		return(MStateMachineStateOutputFiringEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStateOutputFiringEvent2(void) const noexcept
	{
		return(MStateMachineStateOutputFiringEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStateOutputFiredStateOutput1Event1(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput1Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStateOutputFiredStateOutput1Event2(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput1Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStateOutputFiredStateOutput2Event1(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput2Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStateOutputFiredStateOutput2Event2(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput2Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStateOutputFiredStateOutput3Event1(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput3Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStateOutputFiredStateOutput3Event2(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput3Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStateOutputFiredStateOutput4Event1(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput4Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetStateMachineStateOutputFiredStateOutput4Event2(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput4Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetChildStateMachineAddedEvent1(void) const noexcept
	{
		return(MChildStateMachineAddedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetChildStateMachineAddedEvent2(void) const noexcept
	{
		return(MChildStateMachineAddedEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetChildStateMachineFinishedEvent1(void) const noexcept
	{
		return(MChildStateMachineFinishedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException2::GetChildStateMachineFinishedEvent2(void) const noexcept
	{
