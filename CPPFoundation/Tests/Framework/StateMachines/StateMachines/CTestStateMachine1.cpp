...
//----------------------------------------------------------------------------------------------------------------------
	bool CTestStateMachine1::InternalExecuteStateMachine(CCSPStateInput StateInput)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachine1::InternalTerminateStateMachine(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	CTimeout CTestStateMachine1::InternalGetStateMachineTimeout(CSteadyClock::Milliseconds TimeInMS) const
	{
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachine1::StateMachineStartedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachine1::StateMachineFinishedEvent(void)
	{
		MStateMachineFinishedEvent++;
	}
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachine1::StateMachineExpiredEvent(void)
	{
		MStateMachineExpiredEvent++;
	}
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachine1::StateMachineStateChangedEvent(const CState&, const CString&)
	{
		MStateMachineStateChangedEvent++;
	}
//----------------------------------------------------------------------------------------------------------------------
	bool CTestStateMachine1::StateMachineStateOutputFiringEvent(CCSPStateOutput StateOutput)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachine1::ChildStateMachineAddedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachine1::ChildStateMachineFinishedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetInternalGetStateMachineStartState(void) const noexcept
	{
		return(MInternalGetStateMachineStartState);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetInternalExecuteStateMachine(void) const noexcept
	{
		return(MInternalExecuteStateMachine);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetStateMachineExecuteStateMachineStateInput1Event(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput1Event);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetStateMachineExecuteStateMachineStateInput2Event(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput2Event);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetStateMachineExecuteStateMachineStateInput3Event(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput3Event);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetStateMachineExecuteStateMachineStateInput4Event(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput4Event);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetInternalTerminateStateMachine(void) const noexcept
	{
		return(MInternalTerminateStateMachine);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetInternalGetStateMachineTimeout(void) const noexcept
	{
		return(MInternalGetStateMachineTimeout);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetStateMachineStartedEvent(void) const noexcept
	{
		return(MStateMachineStartedEvent);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetStateMachineFinishedEvent(void) const noexcept
	{
		return(MStateMachineFinishedEvent);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetStateMachineExpiredEvent(void) const noexcept
	{
		return(MStateMachineExpiredEvent);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetStateMachineStateChangedEvent(void) const noexcept
	{
		return(MStateMachineStateChangedEvent);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetStateMachineStateOutputFiringEvent(void) const noexcept
	{
		return(MStateMachineStateOutputFiringEvent);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetStateMachineStateOutputFiredStateOutput1Event(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput1Event);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetStateMachineStateOutputFiredStateOutput2Event(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput2Event);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetStateMachineStateOutputFiredStateOutput3Event(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput3Event);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetStateMachineStateOutputFiredStateOutput4Event(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput4Event);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetChildStateMachineAddedEvent(void) const noexcept
	{
		return(MChildStateMachineAddedEvent);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachine1::GetChildStateMachineFinishedEvent(void) const noexcept
	{
