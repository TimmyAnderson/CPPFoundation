//----------------------------------------------------------------------------------------------------------------------
#include "CTestStateMachineException3.h"
...
//----------------------------------------------------------------------------------------------------------------------
	bool CTestStateMachineException3::InternalExecuteStateMachine(CCSPStateInput StateInput)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException3::InternalTerminateStateMachine(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	CTimeout CTestStateMachineException3::InternalGetStateMachineTimeout(CSteadyClock::Milliseconds TimeInMS) const
	{
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException3::StateMachineStartedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException3::StateMachineFinishedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException3::StateMachineExpiredEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException3::StateMachineStateChangedEvent(const CState&, const CString&)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	bool CTestStateMachineException3::StateMachineStateOutputFiringEvent(CCSPStateOutput StateOutput)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException3::ChildStateMachineAddedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
	void CTestStateMachineException3::ChildStateMachineFinishedEvent(void)
	{
...
//----------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetInternalGetStateMachineStartState1(void) const noexcept
	{
		return(MInternalGetStateMachineStartState1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetInternalGetStateMachineStartState2(void) const noexcept
	{
		return(MInternalGetStateMachineStartState2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetInternalExecuteStateMachine1(void) const noexcept
	{
		return(MInternalExecuteStateMachine1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetInternalExecuteStateMachine2(void) const noexcept
	{
		return(MInternalExecuteStateMachine2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineExecuteStateMachineStateInput1Event1(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput1Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineExecuteStateMachineStateInput1Event2(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput1Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineExecuteStateMachineStateInput2Event1(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput2Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineExecuteStateMachineStateInput2Event2(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput2Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineExecuteStateMachineStateInput3Event1(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput3Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineExecuteStateMachineStateInput3Event2(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput3Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineExecuteStateMachineStateInput4Event1(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput4Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineExecuteStateMachineStateInput4Event2(void) const noexcept
	{
		return(MStateMachineExecuteStateMachineStateInput4Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetInternalTerminateStateMachine1(void) const noexcept
	{
		return(MInternalTerminateStateMachine1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetInternalTerminateStateMachine2(void) const noexcept
	{
		return(MInternalTerminateStateMachine2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetInternalGetStateMachineTimeout1(void) const noexcept
	{
		return(MInternalGetStateMachineTimeout1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetInternalGetStateMachineTimeout2(void) const noexcept
	{
		return(MInternalGetStateMachineTimeout2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStartedEvent1(void) const noexcept
	{
		return(MStateMachineStartedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStartedEvent2(void) const noexcept
	{
		return(MStateMachineStartedEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineFinishedEvent1(void) const noexcept
	{
		return(MStateMachineFinishedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineFinishedEvent2(void) const noexcept
	{
		return(MStateMachineFinishedEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineExpiredEvent1(void) const noexcept
	{
		return(MStateMachineExpiredEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineExpiredEvent2(void) const noexcept
	{
		return(MStateMachineExpiredEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStateChangedEvent1(void) const noexcept
	{
		return(MStateMachineStateChangedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStateChangedEvent2(void) const noexcept
	{
		return(MStateMachineStateChangedEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStateOutputFiringEvent1(void) const noexcept
	{
		return(MStateMachineStateOutputFiringEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStateOutputFiringEvent2(void) const noexcept
	{
		return(MStateMachineStateOutputFiringEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStateOutputFiredStateOutput1Event1(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput1Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStateOutputFiredStateOutput1Event2(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput1Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStateOutputFiredStateOutput2Event1(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput2Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStateOutputFiredStateOutput2Event2(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput2Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStateOutputFiredStateOutput3Event1(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput3Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStateOutputFiredStateOutput3Event2(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput3Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStateOutputFiredStateOutput4Event1(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput4Event1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetStateMachineStateOutputFiredStateOutput4Event2(void) const noexcept
	{
		return(MStateMachineStateOutputFiredStateOutput4Event2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetChildStateMachineAddedEvent1(void) const noexcept
	{
		return(MChildStateMachineAddedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetChildStateMachineAddedEvent2(void) const noexcept
	{
		return(MChildStateMachineAddedEvent2);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetChildStateMachineFinishedEvent1(void) const noexcept
	{
		return(MChildStateMachineFinishedEvent1);
	}
//----------------------------------------------------------------------------------------------------------------------
	Size CTestStateMachineException3::GetChildStateMachineFinishedEvent2(void) const noexcept
	{
